...
class GANProblem(problem.Problem):
    ...
    def load_data(self):
        self.XTY_u, self.XT_r, self.XT_test, self.X_mean, self.X_std, self.T_mean, self.T_std = get_data(noise_level=self.hparam['noise_level'],
                                                                                N_r=self.hparam['N_r'],
                                                                                N_u=self.hparam['N_u'])
    ...
    def train_model(self):
        ...
        '''
        gan.train(self.XTY_u, self.XT_r, self.XT_test)
